...
#from GenParticleConstants import *
...
if os.environ.get('CMSSW_BASE') == None:
    ...
    file = TFile.Open('ttbar-allhad_16_1of36_first100Events.root')
...
for entry in range(0,nevents):
    ...
    for i,p in enumerate(genParticlesColl):
        ...
        this_gen_part.SetPDGName(abs(this_gen_part.pdgId))#constants.PDGIds,abs(this_gen_part.pdgId))
