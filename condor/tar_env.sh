...
tar --exclude-caches-all --exclude-vcs -cvzf THBoostedAllHad.tgz \
    ...
    --exclude=CMSSW_12_3_5/src/TIMBER/bin/backup_* \
    ...
    --exclude=CMSSW_12_3_5/src/TopHBoostedAllHad/triggers/backup_* \
    --exclude=CMSSW_12_3_5/src/TopHBoostedAllHad/rootfiles/backup_* \
    CMSSW_12_3_5
