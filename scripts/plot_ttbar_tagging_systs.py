...
def plotSigTemplates(outFile,variations,xTitle="",yTitle="",yRange=[],xRange=[],log=True,rebinX=1,luminosity="36.3",projection="",slices=[0,-1],normalize=False):
    ...
    for variation in variations:
        tempFile = r.TFile.Open('rootfiles/THselection_HT750_ttbar-allhad_18{}_1of10.root'.format(variation if variation == '' else '_'+variation))
...
if __name__ == "__main__":
    for proj in ['x','y']:
        plotSigTemplates(
        outFile=f'plots/ttbar_tagging_systs_PNetXbb_{proj}.png',
